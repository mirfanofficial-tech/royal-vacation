...
// Media assets, Destinations and FAQs — demo counts, no backend yet. Pages
// and Blog posts are merged in live by the Content Hub page itself.
export const contentHubDemoTypeCounts: ContentHubTypeCount[] = [
  { id: "media", label: "Media assets", count: 2916 },
  { id: "destination", label: "Destinations", count: 86 },
  { id: "faq", label: "FAQs", count: 55 },
];

export const contentHubMediaAssets = {
  count: 2916,
  storageUsedGb: 18.4,
  storageTotalGb: 50,
};
...
// ---------------------------------------------------------------------------
// Media Library — no upload/asset backend exists yet, so the seed assets and
// folder counts below are demo data (disclosed via the page's own banner).
// Folder counts are independent display figures, not literally derived from
// the dozen seed assets, matching the same convention as
// contentHubDemoTypeCounts above. The page itself layers real interactions
// on top (upload, search, alt text/tag editing) using local state.
// ---------------------------------------------------------------------------
...
export const mediaFolders: MediaFolder[] = [
  { id: "properties", name: "Properties", count: 1284 },
  { id: "destinations", name: "Destinations", count: 486 },
  { id: "blog", name: "Blog", count: 342 },
  { id: "hero-banners", name: "Hero banners", count: 96 },
  { id: "brand-assets", name: "Brand assets", count: 58 },
  { id: "documents", name: "Documents", count: 124 },
  { id: "video", name: "Video", count: 31 },
  { id: "unsorted", name: "Unsorted", count: 495 },
];
...
export const mediaAssetsSeed: MediaAsset[] = [
  {
    id: "med_001",
    filename: "dubai-skyline-dusk.jpg",
    type: "image",
    folderId: "hero-banners",
    width: 2400,
    height: 1200,
    sizeKb: 486,
    format: "JPEG",
    ...
    usedInCount: 4,
    tags: ["dubai", "skyline", "hero"],
    altTextEn: "Dubai skyline at dusk with the Burj Khalifa lit against an orange sky",
  },
  {
    id: "med_002",
    filename: "maldives-sandbar.jpg",
    type: "image",
    folderId: "destinations",
    width: 2400,
    height: 1350,
    sizeKb: 512,
    format: "JPEG",
    uploadedAt: "2026-08-11T14:20:00Z",
    uploadedBy: "Daniel Ruiz",
    usedInCount: 2,
    tags: ["maldives", "beach"],
    altTextEn: "",
  },
  {
    id: "med_003",
    filename: "istanbul-bosphorus.jpg",
    type: "image",
    folderId: "destinations",
    width: 1920,
    height: 1080,
    sizeKb: 398,
    format: "JPEG",
    uploadedAt: "2026-08-10T11:05:00Z",
    uploadedBy: "Sana Mirza",
    usedInCount: 3,
    tags: ["istanbul", "bosphorus"],
    altTextEn: "",
  },
  {
    id: "med_004",
    filename: "burj-al-arab-suite.jpg",
    type: "image",
    folderId: "properties",
    width: 1600,
    height: 1067,
    sizeKb: 342,
    format: "JPEG",
    uploadedAt: "2026-08-09T08:40:00Z",
    uploadedBy: "Omar Farooq",
    usedInCount: 1,
    tags: ["dubai", "suite", "luxury"],
    altTextEn: "",
  },
  {
    id: "med_005",
    ...
    sizeKb: 604,
    format: "JPEG",
    uploadedAt: "2026-08-08T17:15:00Z",
    uploadedBy: "Elena Costa",
    usedInCount: 2,
    tags: ["santorini", "sunset"],
    altTextEn: "",
  },
  {
    id: "med_006",
  ...
  {
    id: "med_007",
    filename: "resort-walkthrough.mp4",
    type: "video",
    folderId: "video",
    sizeKb: 49152,
    format: "1080p · 2:14",
    uploadedAt: "2026-07-20T13:30:00Z",
    uploadedBy: "James Wu",
    usedInCount: 1,
    tags: ["resort", "video"],
    altTextEn: "",
  ...
  {
    id: "med_008",
    filename: "bali-rice-terrace.jpg",
    type: "image",
    folderId: "destinations",
    width: 2400,
    height: 1600,
    sizeKb: 588,
    format: "JPEG",
    uploadedAt: "2026-08-07T09:45:00Z",
    uploadedBy: "James Wu",
    usedInCount: 3,
    tags: ["bali", "rice-terrace"],
    altTextEn: "",
  },
  {
    id: "med_009",
    filename: "logo-royal-gold.svg",
    type: "vector",
    folderId: "brand-assets",
    sizeKb: 12,
    format: "SVG",
  ...
  {
    id: "med_010",
    filename: "cappadocia-balloons.jpg",
    type: "image",
    folderId: "destinations",
    width: 2400,
    height: 1350,
    sizeKb: 521,
    format: "JPEG",
    uploadedAt: "2026-08-06T06:20:00Z",
    uploadedBy: "Sana Mirza",
    usedInCount: 1,
    tags: ["cappadocia", "balloons"],
    altTextEn: "",
  },
  {
    id: "med_011",
    filename: "singapore-marina.jpg",
    type: "image",
    folderId: "properties",
    width: 1920,
    height: 1280,
    sizeKb: 445,
    format: "JPEG",
    uploadedAt: "2026-08-05T19:10:00Z",
    uploadedBy: "Daniel Ruiz",
    usedInCount: 2,
    tags: ["singapore", "marina"],
    altTextEn: "",
  },
  {
    id: "med_012",
