  ...
  return (
    ...
    >
          ...
          <Controller
            ...
            render={({ field }) => (
              <DestinationAutocomplete
                ...
                inputRef={field.ref}
                inputClassName="w-full border-none bg-transparent p-0 text-sm text-foreground outline-none placeholder:text-muted-foreground"
              />
            )}
          />
        </div>
      ...
      <DateRangePicker
        ...
        triggerClassName="justify-center md:border-l md:border-border px-4 py-2"
        numberOfMonths={2}
      />

      <Popover>
        <PopoverTrigger className="flex flex-col items-start justify-center gap-0.5 md:border-l md:border-border px-4 py-2 text-left">
        ...
        <PopoverContent className="w-[min(80vw,16rem)] space-y-4" align="start">
