...
const footerColumns = [
  ...
  },
  {
    ...
    links: ["Dubai", "Istanbul", "London", "Baku", "Bangkok"],
  },
];
...
export function Footer() {
  return (
    <footer className="mt-10 border-t border-border bg-cream">
      <div className="mx-auto grid max-w-[1400px] grid-cols-2 gap-10 px-6 py-12 sm:grid-cols-3 lg:grid-cols-6 lg:px-10">
        <div className="col-span-2 flex flex-col gap-3 sm:col-span-3 lg:col-span-1">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="flex flex-col leading-none">
              <span className="font-heading text-lg font-bold text-navy">ROYAL</span>
          ...
          <p className="text-sm text-muted-foreground">
            Your journey, our priority. Find the best places to stay, experience amazing
            destinations and create unforgettable memories, together.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          <h3 className="text-sm font-semibold text-navy">Download the app</h3>
          <div className="flex flex-col gap-2">
            <Link
              href="#"
              className="flex items-center gap-2 rounded-lg border border-border bg-white px-3 py-2 text-xs font-medium text-foreground hover:border-navy"
            >
        ...
        <div className="mx-auto flex max-w-[1400px] flex-col-reverse items-center justify-between gap-4 px-6 py-6 sm:flex-row lg:px-10">
          ...
          <div className="flex items-center gap-3">
            {socialLinks.map(({ icon: Icon, label }) => (
              <Link
                ...
                href="#"
                aria-label={label}
                className="flex h-8 w-8 items-center justify-center rounded-full bg-navy text-white hover:bg-navy-light"
              >
          ...
          <div className="flex items-center gap-2">
            {paymentMethods.map((method) => (
              <span
                key={method}
                className="rounded border border-border bg-white px-2 py-1 text-[10px] font-semibold text-muted-foreground"
              >
                {method}
              </span>
            ))}
