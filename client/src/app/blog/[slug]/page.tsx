  ...
  return (
    <>
      ...
      <main className="flex-1 bg-white">
        <div className="mx-auto max-w-[1400px] px-4 sm:px-6 pt-6 lg:px-24">
          <Breadcrumb
            items={[
              { label: "Home", href: "/" },
        ...
        {post.cover_image_url ? (
          <div className="relative mt-4 h-[380px] w-full overflow-hidden bg-muted sm:h-[440px]">
            ...
            <div className="absolute inset-x-0 bottom-0">
              <div className="mx-auto max-w-[1400px] px-4 sm:px-6 pb-8 lg:px-24">
                {post.category_name && post.category_slug && (
                  <Link
          ...
          <div className="mx-auto mt-4 max-w-[1400px] px-4 sm:px-6 lg:px-24">
            {post.category_name && post.category_slug && (
              <Link
                href={`/blog?category=${post.category_slug}`}
